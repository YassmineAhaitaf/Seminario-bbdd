...
Ahora , procedemos a saber el total de pacientes con diágnostico de gravedad **crítico** y **antecedentes familiares** han tenido que recorrer a una **intervención quirúrgica** : 

```{sql, connection=con}
SELECT ID_pacientes, Nombre, Edad, Genero, Antecedentes_familiar, Gravedad, tipo_tratamiento
FROM ConsultaFiltrada
WHERE Gravedad = 'Crítica'
AND tipo_tratamiento = 'Intervención Quirúrgica'
AND Antecedentes_familiar = 'Sí';
